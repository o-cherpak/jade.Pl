...
function renderTickets(startCityId, endCityId, schedules, cities, date) {
  ...
  rightSchedules.forEach((schedule) => {
    ...
    ticketDiv.innerHTML = `
      ...
      <button class="mt-4 md:mt-0 bg-gradient-to-r from-blue-500 to-blue-700 text-white px-6 py-3 rounded-lg shadow hover:from-blue-600 hover:to-blue-800 transition-all font-semibold text-lg flex items-center gap-2">
